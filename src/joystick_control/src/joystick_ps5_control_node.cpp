...
public:
    ...
    {
        // 创建机械臂控制消息发布者
        pub_ = nh_.advertise<diana7_msgs::Joint>("joint_control_topic", 10);
    ...
    void joyCallback(const sensor_msgs::Joy::ConstPtr &joy)
    {
        ...
        diana7_msgs::Joint Velocity_msg;
        
        Velocity_msg.J[0]=left_stick_x;
        Velocity_msg.J[1]=left_stick_y;
        Velocity_msg.J[2]=right_stick_x;
        Velocity_msg.J[3]=right_stick_y;
        Velocity_msg.J[4]=button_left_right;
        Velocity_msg.J[5]=button_up_down;
        Velocity_msg.J[6]=button_a-button_b;
        pub_.publish(Velocity_msg);
        // 只有当12号按键按下使按钮状态改变的时候才会发布这个话题，其他按键按下的时候不会发布，避免重复触发
